...
// Enlaces exactos confirmados por el negocio para estas 4 paradas
// (reemplazan la búsqueda automática por nombre, que es menos precisa).
const ENLACES_FIJOS = {
  "Playa Bluff": "https://maps.app.goo.gl/Yr2L6Evy45L1WFPaA",
  "Blue Lagoon / La Piscina": "https://maps.app.goo.gl/cTDUpRDzu27HjFxNA",
  "Playa Paunch (snorkel)": "https://maps.app.goo.gl/6BduiyCmMi2qb5yAA",
  "Paunch Beach (snorkeling)": "https://maps.app.goo.gl/6BduiyCmMi2qb5yAA",
  "La Gruta": "https://maps.app.goo.gl/2RiUj4VQjNRy5Vue9",
  "La Gruta (the cave)": "https://maps.app.goo.gl/2RiUj4VQjNRy5Vue9",
};

RUTA.es.forEach((p) => (p.mapsLink = ENLACES_FIJOS[p.nombre] || mapsQuery(p.mapsNombre)));
RUTA.en.forEach((p) => (p.mapsLink = ENLACES_FIJOS[p.nombre] || mapsQuery(p.mapsNombre)));
...
export const TEXTOS_EXITO = {
  es: {
    ...
    resenaTituloFinal: "¿Ya viviste la experiencia? ¡Cuéntanos!",
    resenaTextoFinal: "Cuando termines tu recorrido, nos harías muy felices con una reseña:",
  ...
  en: {
    ...
    resenaTituloFinal: "Had a great time out there? Tell us about it!",
    resenaTextoFinal: "Once you're back from your ride, we'd love a review:",
