...
// ---- Ebikes ----
export const TARIFA_EBIKE_DIA = 15;

// Los ebikes tienen una tarifa fija: $15/día. La hora de entrega no importa
...
export function calcularTarifaEbike({ fechaEntrega, fechaPrevista }) {
  const dias = Math.max(0, diasEntre(fechaEntrega, fechaPrevista)) + 1;
  return { total: TARIFA_EBIKE_DIA * dias, dias };
}
